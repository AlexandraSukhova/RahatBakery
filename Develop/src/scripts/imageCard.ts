...
export function createMenuImageCard(cardInfo: MenuItem, blockName: string, container: HTMLTemplateElement) {
  ...
  const cardHeader = ImageCard.querySelector(`.${blockName}-header`) as HTMLHeadingElement;
  ...
  cardInfo.imgUrl? cardImage.src = cardInfo.imgUrl : console.log('Изображение не найдено');
